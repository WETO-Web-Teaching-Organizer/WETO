...
primary key (id),
unique (loginName));
drop table if exists UserIdReplication cascade;
...
drop table if exists ClusterIdReplication cascade;
...
drop table if exists SubtaskLink cascade;
...
primary key (id),
foreign key (taskId) references Task(id));
drop table if exists PermissionIdReplication cascade;
...
drop table if exists AutoGrading cascade;
...
foreign key (taskId) references Task(id));
drop table if exists AutoGradeTestScore cascade;
...
drop table if exists AutoGradeJobQueue cascade;
...
primary key (id),
foreign key (taskId) references Task(id));
drop table if exists SubmissionDocument cascade;
...
drop table if exists SubmissionProperties cascade;
...
primary key (taskId),
foreign key (taskId) references Task(id));
drop table if exists TaskDocument cascade;
...
drop view if exists SubtaskView;
