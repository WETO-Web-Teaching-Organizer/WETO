...
/**
 * Generated bean class for Grade. This class extends the database access class
 * by adding bean property getters and setters.
 */
public class BeanGrade extends DbGrade
{
   ...
   * @throws InvalidValueException if the new value is not valid.
   */
  public void setReviewerId(java.lang.Integer newValue) throws
   ...
   * @throws InvalidValueException if the new value is not valid.
   */
  public void setReceiverId(java.lang.Integer newValue) throws
          InvalidValueException
  {
   ...
   * @throws InvalidValueException if the new value is not valid.
   */
  public void setTimeStamp(java.lang.Integer newValue) throws
          InvalidValueException
  {
