 ...
 */
package fi.uta.cs.weto.interceptors;
...
public class RedirectMessageInterceptor extends MethodFilterInterceptor
{
  ...
  public static final String FIELD_ERRORS_KEY
                             = "RedirectMessageInterceptor_FieldErrors";
  public static final String ACTION_ERRORS_KEY
                             = "RedirectMessageInterceptor_ActionErrors";
  public static final String ACTION_MESSAGES_KEY
          ...
          ValidationAware validationAware) throws Exception
  {
    ...
    Collection<String> actionErrors = (Collection<String>) session.remove(
            ACTION_ERRORS_KEY);
    ...
    @SuppressWarnings("unchecked")
    Collection<String> actionMessages = (Collection<String>) session.remove(
            ACTION_MESSAGES_KEY);
