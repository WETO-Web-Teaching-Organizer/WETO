    ...
    tablesorter: new
            function () {
              ...
              function multisort(table, sortList, cache) {
                Cookies.set(table.id + location.search.replace(/[\?=&]/g, ""), JSON.stringify(sortList).replace(",", "_"));
                if (table.config.debug) {
              ...
              function makeSortFunction(type, direction, index) {
                ...
                if (type == 'text' && direction == 'asc') {
                  ...
                  return "(" + a + " == " + b + " ? 0 : (" + a + " === null ? 1 : (" + b + " === null ? -1 : (" + b + " < " + a + ") ? -1 : 1 )));";
                } else if (type == 'numeric' && direction == 'asc') {
                  return "(" + a + " === null && " + b + " === null) ? 0 :(" + a + " === null ? 1 : (" + b + " === null ? -1 : " + a + " - " + b + "));";
                } else if (type == 'numeric' && direction == 'desc') {
                  return "(" + a + " === null && " + b + " === null) ? 0 :(" + a + " === null ? 1 : (" + b + " === null ? -1 : " + b + " - " + a + "));";
                }
              }
              ;
              ...
              this.construct = function (settings) {
                return this.each(function () {
                          ...
                          function (e) {
                            ...
                            if (!this.sortDisabled && totalRows > 0) {
                              ...
                              if (!e[config.sortMultiSortKey]) {
                                ...
                                // the user has clicked on an already
                                // sorted column.
                  ...
                  // Check cookie for previous sort order
                  var lastSort = Cookies.get(this.id + location.search.replace(/[\?=&]/g, ""));
                  if (lastSort)
                  {
                    config.sortList = JSON.parse(lastSort.replace("_", ","));
                  }
