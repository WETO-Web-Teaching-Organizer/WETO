...
<h2><s:text name="grading.header.deleteGrade" /></h2>
<p>
  <s:text name="deleteGrade.text.confirmation" />
</p>
<p>
  <s:url action="commitDeleteGrade" var="commitDeleteGradeURL">
  ...
  <s:a href="%{commitDeleteGradeURL}" cssClass="btn btn-danger">
  ...
  <s:a href="%{viewGradeURL}" cssClass="btn btn-default">
      ...
      <td>
        <div class="contentBox">
          <h4>
            ...
            <s:a href="%{viewSubmissionUrl}" cssClass="smallLinkButton">
